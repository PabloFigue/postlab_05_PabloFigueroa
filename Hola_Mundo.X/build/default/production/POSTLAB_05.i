...
restart_tmr0 macro
  ...
  bcf ((INTCON) and 07Fh), 2 ;Se apaga la bandera de interrupción por Overflow del TMR0
  endm
...
isr: ;instrucciones de la interrupcion
    btfsc ((INTCON) and 07Fh), 0 ;Verificacion de la bandera de interrupcion del PORTB
    call inte_portb
...
config_tmr0:
    ...
    bcf ((OPTION_REG) and 07Fh), 3 ;Preescaler en TMR0
    bcf ((OPTION_REG) and 07Fh), 2
    bsf ((OPTION_REG) and 07Fh), 1
    bcf ((OPTION_REG) and 07Fh), 0 ;Prescaler de 1:8 (010)
    restart_tmr0
    return
